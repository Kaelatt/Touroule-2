...
/* Page en HTML ↓ */?>
    <header>
        <h1>Conditions Générale d'Utilisation</h1>
        <p>
            En vigueur au 14/01/2022
        </p>
    </header>
    <br/>
    <br/>
    ...
    <div class="article" role="article">
        <p>
            ...
            modalités de mise à disposition du site et des services par Touroule et de définir les
            ...
            Touroule se réserve le droit de modifier unilatéralement et à tout moment le contenu des
            présentes CGU.
        </p>

        <div class="corpArticle" id="article1">
            <p>
                ARTICLE 1 : Mentions légales
                Si l’édition du site est assurée par une personne morale :
                L'édition du site Touroule est assurée par la Société BCMCS au capital de trente-douze euros, immatriculée au RCS de Maubeuge sous le numéro
                SIREN Arielle dont le siège social est situé au fin fond de nos coeurs,
                lassainora@lassainora.fr.
                N° de TVA intracommunautaire : cinquante-douze
                Le Directeur de la publication c'est nous.
                L'hébergeur du site Touroule est la Société OVH.

            </p>
        </div>
        <div class="corpArticle" id="article2">
            <p>
                ARTICLE 2 : Accès au site
                Le site Touroule permet à l'Utilisateur un accès gratuit aux proposition de ventes et mise en vente du site.
                Le site est accessible gratuitement en tout lieu à tout Utilisateur ayant un accès à Internet. Tous les frais
                supportés par l'Utilisateur pour accéder au service sont à sa charge.
                ...
                En cas de non respect des conditions générales de vente et/ou d’utilisation, le site Touroule
                ...
                responsabilité de Touroule. Dans ces cas, l’Utilisateur accepte ainsi ne pas tenir rigueur à
        ...
        <div class="corpArticle" id="article3">
            <p>
                ...
                Le site est déclaré à la CNIL sous le numéro quarante-douze.
                ...
                • par mail à lassainora@lassanora.fr
        ...
        <div class="corpArticle" id="article4">
            <p>
                ...
                La marque BCMCS est une marque déposée par l'équipe de projet.Toute représentation
        ...
        <div class="corpArticle" id="article5">
            <p>
                ARTICLE 5 : Responsabilité
                Les sources des informations diffusées sur le site Touroule sont réputées fiables mais le site
                ...
                des mises à jour régulières, le site Touroule ne peut être tenu responsable de la modification
                ...
                Le site Touroule ne peut être tenu pour responsable d’éventuels virus qui pourraient infecter
        ...
        <div class="corpArticle" id="article7">
            <p>
                ...
                par votre navigateur et qui sont nécessaires à l’utilisation du site Touroule. Les cookies ne
        ...
        <div class="corpArticle" id="article8">
            <p>
                ARTICLE 8 : Publication par l’Utilisateur
                Le site permet aux membres de publier des annonces.
                ...
                entier, sur tout support, pour la durée de la propriété intellectuelle. Le Membre
        ...
        <div class="corpArticle" id="article9">
            <p>
        ...
        <div class="corpArticle">
            <p>Voir aussi : <a href="<?= $origine.'infos/conditions_generale/vente' ?>" >Conditions Générale de Vente</a></p>
        </div>
    </div>
<?php /* Page en HTML ↑ */
